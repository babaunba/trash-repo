...
const (
	Tags_GenerateTags_FullMethodName = "/tags.v1.Tags/GenerateTags"
)
...
func (c *tagsClient) GenerateTags(ctx context.Context, in *GenerateTagsRequest, opts ...grpc.CallOption) (*GenerateTagsResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GenerateTagsResponse)
	err := c.cc.Invoke(ctx, Tags_GenerateTags_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedTagsServer) GenerateTags(context.Context, *GenerateTagsRequest) (*GenerateTagsResponse, error) {
...
func _Tags_GenerateTags_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GenerateTagsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(TagsServer).GenerateTags(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Tags_GenerateTags_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TagsServer).GenerateTags(ctx, req.(*GenerateTagsRequest))
	}
...
var Tags_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "tags.v1.Tags",
	HandlerType: (*TagsServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "GenerateTags",
			Handler:    _Tags_GenerateTags_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "proto/tags/v1/tags.proto",
}
